...
test("switchMap", async () => {
  ...
  >(true);
  expect(goodValSwitchMappedToBadResult).toMatchObsResult(
    Result.Err(new Date(3)),
  );
  ...
  expect(goodValSwitchMappedToNonResult).toMatchObsResult(
    Result.Ok(new Date(3)),
  );
...
test("switchMap", async () => {
  ...
  eq<
    ...
    Observable<Result<number, Date | number>>
  >(true);
  expect(goodValMergeMappedToBadResult).toMatchObsResult(
    Result.Err(new Date(3)),
  );
  ...
  expect(goodValMergeMappedToNonResult).toMatchObsResult(
    Result.Ok(new Date(3)),
  );
